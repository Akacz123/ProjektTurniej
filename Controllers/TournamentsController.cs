...
namespace EsportsTournament.API.Controllers
{
    ...
    public class TournamentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> ClearRegistrations(int id)
        {
            ...
            var individuals = _context.TournamentRegistrationIndividual.Where(r => r.TournamentId == id);
            _context.TournamentRegistrationIndividual.RemoveRange(individuals);

            await _context.SaveChangesAsync();
            return Ok(new { Message = "Wyczyszczono wszystkich uczestników turnieju. Możesz zapisać ich na nowo." });
        }
